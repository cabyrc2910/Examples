...
// }
// Method1();                              // Вызов метода   "Идентификатор метода и ()
...
// void Method21(string msg, int count) // Именованные аргументы, когда указывается какому аргументу , какое значение мы хотим указать
// {
